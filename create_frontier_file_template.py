...
dataloader_params = dict( # A REVOIR POUR LES DONNEES TWEETS
    ...
    batch_size=2,
    shuffle=False,
    batch_sampler=samplers.OneSentenceBatchSampler,
    sampler=None,
    num_workers=0,
...
parameters['create_frontier_function'] = frontier.create_all_points_frontier
parameters['lr'] = 0.0005  # Always
parameters['collate_fn'] = linear_interpolation_collate_fn
parameters['execution_name'] = "SpecialExecutionCreateFile"  # Always
